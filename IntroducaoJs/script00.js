...
nome = "José";//Restribuição de valor let
//let nome = "Pedro"; erro não pode redeclarar

var idade = 25;//Numeric
idade = 26;//Reatribuição o valor var
var idade = 30;//Redaclarar - ok

const PI = 3.1415;//Numeric
//PI = 3.1954; //Não pode reatribuir
...
console.log("a==c: "+(a==c));//comparação de igualdade simples 
console.log("a===c: "+(a===c));//comparação de igualdade Estrita 
